...
### Introduction
Under abiotic stress such as salinity, several morphological and physiological parameters of plants are affected. In function of their location, plants from the same species could exhibit difference tolerance to abiotic stress. In the study we will review, 25 accession of E. sativa from different region of Pakistan were analysed. Each accession have been seperated into two groups receiving different treatment: first group is the control and the second underwent salt stress (150 mM NaCl) during two weeks. Following, that 19 morpho-physiological traits were mesured.
...
#### Tidying of data
```{r Tidy_data.R, echo = TRUE, message=FALSE }
